...
R_NMPC_nowind=dlmread('/home/hakim/testing_ws/src/simulation/Results/Data/realtime/nmpc_low_wind.txt');
...
M_VT_nowind = dlmread('/home/hakim/testing_ws/src/simulation/Results/Data/5ms/VTMPC.txt');    %VTMPC data

%M_VT_wind = dlmread('/home/hakim/catkin_ws/src/WTI_catkin/Results/Data/VTNMPC/test1.txt');
M_VT_wind = dlmread('/home/hakim/testing_ws/src/simulation/Results/Data/5ms/VTMPC_old.txt');


M_NMPC_nowind=dlmread('//home/hakim/testing_ws/src/simulation/Results/Data/NMPC/no_wind.txt');
M_NMPC_wind=dlmread('/home/hakim/testing_ws/src/simulation/Results/Data/5ms/NMPC.txt');

M_PAMPC_nowind=dlmread('/home/hakim/testing_ws/src/simulation/Results/Data/PAMPC/wind.txt');
M_PAMPC_wind=dlmread('/home/hakim/testing_ws/src/simulation/Results/Data/5ms/PAMPC.txt');
...
mx = dlmread('/home/hakim/testing_ws/src/simulation/Results/Data/Mesh/MeshX.txt');
my = dlmread('/home/hakim/testing_ws/src/simulation/Results/Data/Mesh/MeshY.txt');
mz = dlmread('/home/hakim/testing_ws/src/simulation/Results/Data/Mesh/MeshZ.txt');


%mz(:,:)=mz(:,:)+120;

px = dlmread('/home/hakim/testing_ws/src/simulation/Results/Data/Point_to_View_Trajectory/mp_d1cm_interp_x.txt');       %triangles mesh centres
py = dlmread('/home/hakim/testing_ws/src/simulation/Results/Data/Point_to_View_Trajectory/mp_d1cm_interp_y.txt');
pz= dlmread('/home/hakim/testing_ws/src/simulation/Results/Data/Point_to_View_Trajectory/mp_d1cm_interp_z.txt');
...
plot3(R_NMPC_nowind(1500:end,5),R_NMPC_nowind(1500:end,6),R_NMPC_nowind(1500:end,7),'k', 'LineWidth', 3,'color',color_NMPC);
%hold on
plot3(R_pampc(1700:end-3000,5),R_pampc(1700:end-3000,6),R_pampc(1700:end-3000,7),'k', 'LineWidth', 3,'color',color_PAMPC);

legend('VTNMPC','NMPC','PAMPC')